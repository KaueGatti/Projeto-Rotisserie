...
public class CardapioDAO {
    ...
    public static void create(Cardapio cardapio) throws SQLException {
        ...
        String sql = "INSERT INTO Cardapio (principal_1, principal_2, principal_3, mistura_1, mistura_2, mistura_3, mistura_4," +
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            stmt.setString(3, cardapio.getPrincipal3());
            stmt.setString(4, cardapio.getMistura1());
            stmt.setString(5, cardapio.getMistura2());
            stmt.setString(6, cardapio.getMistura3());
            stmt.setString(7, cardapio.getMistura4());
            stmt.setString(8, cardapio.getGuarnicao1());
            stmt.setString(9, cardapio.getGuarnicao2());
            stmt.setString(10, cardapio.getGuarnicao3());
            stmt.setString(11, cardapio.getGuarnicao4());
            stmt.setString(12, cardapio.getSalada1());
            stmt.setString(13, cardapio.getSalada2());
            stmt.setString(14, LocalDateTime.now().toString());
    ...
    public static Cardapio read() throws SQLException {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            try (ResultSet rs = stmt.executeQuery()) {
                ...
                cardapio.setPrincipal3(rs.getString("principal_3"));
